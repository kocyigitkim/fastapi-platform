...
var FastApiManager_1 = require("./core/FastApiManager");
...
var manager = new FastApiManager_1.FastApiManager();
function appReady() {
    var _this = this;
    electron_1.ipcMain.handle('callManagerFunction', function () {
        var args = [];
    ...
    for (var _i = 0, _a = Object.keys(manager.constructor.prototype); _i < _a.length; _i++) {
        var field = _a[_i];
        if (typeof manager[field] === 'function') {
            console.log('Registered: ' + field);
            electron_1.ipcMain.handle("getManager." + field, (function (parent, fieldName, source) {
                var args = [];
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        r = parent[fieldName].apply(parent, args);
    ...
    electron_1.ipcMain.handle('getManager', function (evt) {
        console.log(manager);
        var cloned = __assign({}, manager);
        for (var _i = 0, _a = Object.keys(manager.constructor.prototype); _i < _a.length; _i++) {
            var field = _a[_i];
            if (typeof manager[field] === 'function') {
                cloned[field] = {
